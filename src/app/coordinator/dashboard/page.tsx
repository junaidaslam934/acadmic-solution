      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
          ...
          <StatCard
            ...
            value={new Set(assignments.map(a => a.teacherId._id)).size}
          ...
          <StatCard
            label="Total Courses"
            value={new Set(assignments.map(a => a.courseId._id)).size}
          ...
          <StatCard
            label="Total Credits"
            value={assignments.reduce((sum, a) => sum + a.courseId.credits, 0)}
